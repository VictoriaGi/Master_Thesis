...
species_order_disti_plot <- ggplot(species_order_disti, aes(x =reorder(Order, Number_taxa), y = Number_taxa, fill = Order )) + geom_bar(stat = "identity") + theme_classic() + theme(legend.position = "none") + geom_text(aes(label = Number_taxa)) 
