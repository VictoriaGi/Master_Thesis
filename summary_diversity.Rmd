...
species_family_all_plot <- ggplot(species_family_all, aes(x =reorder(Family, Number_of_species), y = Number_of_species, fill = Family )) + geom_bar(stat = "identity") + theme_classic() + theme(legend.position = "none") + geom_text(aes(label = Number_of_species)) 
...
species_family_disti_plot <- ggplot(species_family_disti, aes(x =reorder(Family, Number_of_species), y = Number_of_species, fill = Family )) + geom_bar(stat = "identity") + theme_classic() + theme(legend.position = "none") + geom_text(aes(label = Number_of_species)) 
...
species_genus_all_plot <- ggplot(species_genus_all, aes(x =reorder(Genustotal, Number_of_species), y = Number_of_species, fill = Genustotal )) + geom_bar(stat = "identity") + theme_classic() + theme(legend.position = "none") + geom_text(aes(label = Number_of_species)) 
...
species_genus_disti_plot <- ggplot(species_genus_disti, aes(x =reorder(Genustotal, Number_of_species), y = Number_of_species, fill = Genustotal )) + geom_bar(stat = "identity") + theme_classic() + theme(legend.position = "none") + geom_text(aes(label = Number_of_species)) 
...
sum(pond.hab.taxa.disti$Taxa_records)
...
sum(distilake.hab.taxa.disti$Taxa_records)
```
...
sum(reserv.hab.taxa.disti$Taxa_records)
```
...
sum(river.hab.taxa.disti$Taxa_distinct)
```
...
sum(stream.hab.taxa.disti$Taxa_distinct)
```
...
sum(spring.hab.taxa.disti$Taxa_distinct)
```
...
p <- ggplot(unique_species_count, aes(x=reorder(Country, Number_unique_species), y=Number_unique_species, fill = Country)) + geom_bar(stat="identity") +
        theme_classic() + theme(legend.position = "none") + geom_text(aes(label=Number_unique_species)) + coord_flip() + ylab("Number of taxa") + xlab("")
p
#ggsave("p.png")
```
