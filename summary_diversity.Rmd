...
species_family_disti_plot <- ggplot(species_family_disti, aes(x =reorder(Family, Number_of_species), y = Number_of_species, fill = Order )) + geom_bar(stat = "identity") + theme_classic() + theme(legend.position = "none") + geom_text(aes(label = Number_of_species)) 
...
species_genus_disti_plot <- ggplot(species_genus_disti, aes(x =reorder(Genustotal, Number_of_species), y = Number_of_species, fill = Order )) + geom_bar(stat = "identity") + theme_classic() + theme(legend.position = "none") + geom_text(aes(label = Number_of_species)) 
...
taxa.disti.plot <- ggplot(taxa.disti, aes(x=reorder(Country, Taxa_number), y=Taxa_number, fill = Country)) + geom_bar(stat="identity") +
        theme_classic() + theme(legend.position = "none") + geom_text(aes(label=Taxa_number)) + coord_flip() + ylab("Number of taxa") + xlab("")
taxa.disti.plot
```
